              ...
              >
                ...
                <td style={{padding: '8px 16px', textAlign: 'right', verticalAlign: 'middle'}}>
                  <div style={{display: 'flex', gap: '8px', justifyContent: 'flex-end'}}> {/* Increased gap for buttons */}
                    ...
                    {/* Archive and Activate buttons removed as per removal of archive feature */}
                    <button
                      onClick={() => {
                        if (window.confirm('Are you sure you want to permanently delete this project? This action cannot be undone.')) {
                          handleProjectAction(project._id, 'delete');
                        }
                      }}
          ...
          <div style={{
            ...
            <div style={{
              ...
              {(selectedProject.status === 'active' || selectedProject.status === 'inProgress') && (
                <button
                  onClick={() => handleProjectAction(selectedProject._id, 'archive')}
                  disabled={actionLoading}
                  style={{
                    padding: '8px 15px',
                    backgroundColor: '#f97316', // Changed to match "Deactivate" orange
                    color: 'white',
                    border: 'none',
                    borderRadius: '6px',
                    cursor: 'pointer',
              ...
              {selectedProject.status === 'archived' && (
                <button
                  onClick={() => handleProjectAction(selectedProject._id, 'activate')}
                  disabled={actionLoading}
                  style={{
                    padding: '8px 15px',
              ...
              <button
                  onClick={() => {
                    if (window.confirm('Are you sure you want to permanently delete this project? This action cannot be undone.')) {
                      handleProjectAction(selectedProject._id, 'delete');
                    }
                  }}
                  disabled={actionLoading}
                  style={{
